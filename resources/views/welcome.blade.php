    ...
    <div class="bg-gray-50">
        <div class="w-full flex items-center justify-center ">
            <div class="relative w-full">
                <header class="sticky top-0 z-10 ">
                    <div class=" font-sans w-full m-0">
                        <div class="bg-white drop-shadow">
                            <div class="px-16 relative overflow-hidden">
                                <div class="flex items-center justify-between relative h-[100%]">
                                    ...
                                    <div class="hidden sm:flex sm:items-center">
                                        ...
                                        <a href="#"
                                          class="text-gray-800 text-sm font-semibold hover:text-white p-8 hover:bg-[#38bdf8]">About Us</a>
                                    </div>
                ...
                <main class="mt-6" id="home">
                    <x-carousel></x-carousel>

                    <br />
                    <div style="height: 20px;" id="services"></div>
                    <div class="mt-[10rem]" id="services">
                        <div class="flex justify-center items-center">
                            <div class="w-1/2 flex items-center">
                                <div class="relative w-full flex justify-center items-center">
                                    <h3 class="text-center font-black text-3xl font-serif">Let You Adventure Awake with
                                        Just One Click</h3>
                                </div>
                                <div class="inline-block h-[120px] min-h-[1em] w-[3px] mx-8 self-stretch  bg-black">
                                </div>
                                <p class="text-center font-serif text-start text-slate-600">Staring an exiting journey
                                    or experience is easy and accessible, requiring only a simple online action. It
                                    suggests that with a single click, you can bring your adventure to life, emphasizing
                                    both the excitement of exploration and the convenience of digital booking.</p>
                            </div>
                        </div>
                        <div class="mt-20 mx-32">
                            <div class="flex justify-evenly flex-wrap">
                                <div class="w-1/5 flex items-center flex-col justify-start">
                                    <img src="location.png" alt="" class="w-10 h-10 mb-2">
                                    <h1 class="font-black mb-2">Destination Recommendations</h1>
                                    <p class="text-slate-600 text-sm">Discover the top places to visit across Cambodia’s
                                ...
                                <div class="w-1/5 flex items-center flex-col justify-start">
                                    <img src="hotel.png" alt="" class="w-10 h-10 mb-2">
                                    <h1 class="font-black mb-2">Hotel Listings</h1>
                                    <p class="text-slate-600 text-sm">Find the perfect accommodation for your stay. Our
                                        detailed hotel listings include options for every budget and preference,
                                        ensuring a comfortable and enjoyable stay.</p>
                                </div>
                                <div class="w-1/5 flex items-center flex-col justify-start">
                                    <img src="photography.png" alt="" class="w-10 h-10 mb-2">
                                    <h1 class="font-black mb-2">Restaurant Guides</h1>
                                    <p class="text-slate-600 text-sm">Savor the best dining experiences with our curated
                                        restaurant guides. Explore local cuisine and find the best spots to enjoy a meal
                                        in each province.</p>
                                </div>

                            </div>
                            <div class="flex justify-evenly flex-wrap mt-24">
                                <div class="w-1/5 flex items-center flex-col justify-start">
                                    <img src="film.png" alt="" class="w-10 h-10 mb-2">
                                    <h1 class="font-black mb-2">Video Tours</h1>
                                    <p class="text-slate-600 text-sm">Immerse yourself in Cambodia’s beauty with our
                                        exclusive video tours. Each destination, hotel, and restaurant comes with a
                                        video to give you a preview before you go.</p>
                                </div>
                                <div class="w-1/5 flex items-center flex-col justify-start">
                                    <img src="ratings.png" alt="" class="w-10 h-10 mb-2">
                                    <h1 class="font-black mb-2">Feedback & Reviews</h1>
                                    <p class="text-slate-600 text-sm">Share your experiences and help others make
                                        informed decisions. Our feedback option allows you to leave reviews and ratings
                                        for the places you’ve visited.</p>
                                </div>
                                <div class="w-1/5 flex items-center flex-col justify-start">
                                    <img src="lamp.png" alt="" class="w-10 h-10 mb-2">
                                    <h1 class="font-black mb-2">Travel Tips & Advice</h1>
                                    <p class="text-slate-600 text-sm">Access helpful travel tips and advice to make
                                        your journey smoother and more enjoyable. From local customs to travel safety,
                    ...
                    <div class="mt-[12rem]">
                        <div class="flex justify-center">
                            <div class="w-1/2 flex items-center justify-center flex-col">
                                <div class="relative w-full flex justify-center items-center mb-4">
                                    <h3 class="text-center font-black text-3xl font-serif">Choose your best</h3>
                                </div>
                        ...
                        <div class="flex justify-evenly items-center mt-20 mx-[20rem]">
                            <div>
                                <img src="grab.jpg" alt="" class="w-32 h-32">
                                <h1 class="text-center font-bold mt-2">GRAB</h1>
                            </div>
                            <div>
                                <img src="passapp.jpg" alt="" class="w-32 h-32 rounded-2xl">
                                <h1 class="text-center font-bold mt-2">PASSAPP</h1>
                            </div>
                            <div>
                                <img src="lmcard.jpg" alt="" class="w-32 h-32 rounded-2xl">
                                <h1 class="text-center font-bold mt-2">LMCAR</h1>
                            </div>
                        </div>
                        <div class="flex justify-evenly items-center mt-20 mx-[20rem]">
                            <div>
                                <img src="tada.png" alt="" class="w-32 h-32 rounded-2xl">
                                <h1 class="text-center font-bold mt-2">TADA</h1>
                            </div>
                            <div>
                                <img src="larita.jpg" alt="" class="w-32 h-32 rounded-2xl">
                                <h1 class="text-center font-bold mt-2">LARITA</h1>
                            </div>
                            <div>
                                <img src="varakbuntham.jpg" alt="" class="w-32 h-32 rounded-2xl">
                                <h1 class="text-center font-bold mt-2">VIRAK BUNTHAM</h1>
                            </div>
                        </div>
                    ...
                    <div class="mt-[12rem]">
                        <div class="flex justify-center">
                            <div class="w-1/2 flex items-center justify-center flex-col">
                                <div class="relative w-full flex justify-center items-center mb-4">
                                    <h3 class="text-center font-black text-3xl font-serif">Choose your best Guide</h3>
                                </div>
                                <p class="text-center font-serif text-start text-slate-600 tracking-wide">Travel stress - free with fast, affordable, and trusted local rides</p>
                            </div>
                        </div>
                        <div class="flex justify-evenly items-center mt-20 mx-[20rem]">
                            <div>
