    ...
    <div class="container">
        <div class="row justify-content-center ">
            ...
            <div class="col-md-8 shadow-lg rounded-b ">
                <div class="card-body  border-t my-8 border-0">

                    <div class="flex justify-evenly items-center">
                        <div class="w-[80%]">
                            <div class="relative">
                              <input type="search" id="default-search" class="block w-full py-3 px-4 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 shadow" placeholder="Search Here..." required />
                        ...
                        <div>
                            <img src="settings.png" alt="" class="w-10 h-10 cursor-pointer hover:ring-4 hover:ring-gray-400 hover:ring-offset-2 hover:ring-offset-gray-100">
                        </div>
                    </div>
