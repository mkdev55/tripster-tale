...
<body>
    <header class="sticky top-0 z-10 ">
        <div class=" font-sans w-full m-0" x-data="{hide: true}">
            <div class="bg-white drop-shadow">
                <div class="px-16 relative">
                    <div class="flex items-center justify-between relative h-[100%]">
                        ...
                        @auth
                            <div class="hidden sm:flex sm:items-center">
                                ...
                                <x-link link="{{ route('system.user.oppunity.index') }}"
                                    :isCurrent="Route::is('system.user.oppunity.index')">Opportunity</x-link>
                            </div>
                        @endauth
                            ...
                            @auth
                                <div x-data="{ isOpen: false, openedWithKeyboard: false }" class="relative"
                                    ...
                                    <div x-cloak x-show="isOpen || openedWithKeyboard" x-transition
                                        ...
                                        class="absolute top-11 left-0 flex w-full min-w-[10rem] flex-col overflow-hidden rounded-md border border-neutral-300 bg-neutral-50 py-1.5 "
                                        role="menu">
                                        <a href="#"
                                            class="bg-neutral-50 px-4 py-2 text-sm text-neutral-600 hover:bg-neutral-900/5 hover:text-neutral-900 focus-visible:bg-neutral-900/10 focus-visible:text-neutral-900 focus-visible:outline-none "
                                        ...
                                        <form method="post" action="{{ route('logout') }}" class="w-full">
                                            @csrf
                                            <button type="submit"
                                                class="bg-neutral-50 px-4 py-2 w-full text-start
                                        text-sm text-neutral-600 hover:bg-neutral-900/5 hover:text-neutral-900 focus-visible:bg-neutral-900/10 focus-visible:text-neutral-900 focus-visible:outline-none "
                    ...
                    <div class="block sm:hidden bg-white border-t-2 py-2" x-show="!hide">
                        <div class="flex flex-col gap-4">
                            ...
                            <a href="#explore_plan"
                                class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Explore Plan</a>
                            <a href="#booking_flight"
                                class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Booking
                                Flight</a>
                            <a href="#transportation"
                                class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Transportation</a>
                            <a href="#recomendation"
                                class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Overall
                                Recommendations</a>
                            <a href="#aboutus" class="text-gray-800 text-sm font-semibold hover:text-purple-600">About
                                Us</a>
